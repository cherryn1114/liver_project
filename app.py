...
st.write(
    "건강검진 정보와 생활습관 정보를 입력하면 MASLD 위험 수준을 확인할 수 있습니다."
)
...
if st.button("위험 수준 확인하기"):
    ...
    if prediction_value < 0.60:
        ...
        st.write(
            "현재 입력값 기준으로 MASLD 위험 가능성이 낮게 예측되었습니다."
        )
        ...
        st.write(
            "현재 입력값 기준으로 MASLD 위험도가 높게 예측되었습니다. "
            "AI 예측 결과는 참고용 정보이며 실제 진단을 의미하지 않습니다. "
            "보다 정확한 평가와 건강 관리를 위해 가까운 의료기관에서 전문의와 상담해 보시기를 권장드립니다."
        )
